...
aws ssm put-parameter --name /medscribe/dev/WA_ACCESS_TOKEN    --type SecureString --value ...
aws ssm put-parameter --name /medscribe/dev/WA_APP_SECRET      --type SecureString --value ...
aws ssm put-parameter --name /medscribe/dev/WA_VERIFY_TOKEN    --type String       --value ...
aws ssm put-parameter --name /medscribe/dev/WA_PHONE_NUMBER_ID --type String       --value ...
```
...
aws ssm delete-parameters --names /medscribe/dev/SARVAM_API_KEY /medscribe/dev/BEDROCK_API_KEY /medscribe/dev/WA_ACCESS_TOKEN /medscribe/dev/WA_APP_SECRET /medscribe/dev/WA_VERIFY_TOKEN /medscribe/dev/WA_PHONE_NUMBER_ID
...
(delete access keys, remove AdministratorAccess), and Meta -> revoke the system-user token.
